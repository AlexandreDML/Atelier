...
def position_tri(L: list, i: int) ->int:
    """Programme qui renvoie la position d'un élément d'un tableau trié par  recherche dichotomique
    input:
        L : une list d'entier
        i : entier
    output:
...
def a_repetitions(L: list, e: int):
...
print(a_repetitions([5,6,7,8,9], 4))
